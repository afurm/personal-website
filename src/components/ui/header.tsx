...
export function Header() {
    ...
    return (
        <>
            ...
            {isMenuOpen && (
                <div className="fixed inset-0 bg-white dark:bg-gray-950 z-[9999] md:hidden flex flex-col" style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, width: '100vw', height: '100vh' }}>
