...
const skillCategories = [
    {
        ...
        skills: ["React", "Next.js", "TypeScript", "JavaScript", "HTML5", "CSS3", "Tailwind CSS", "Material UI", "Redux", "React Query"]
    },
    {
        category: "Backend Technologies",
        skills: ["Ruby on Rails", "Node.js", "Express", "GraphQL", "REST API", "PostgreSQL", "MongoDB", "Redis", "Sidekiq"]
    },
    {
    ...
    return (
        <section id="skills" className="py-16 md:py-24 bg-secondary/30">
            <div className="container px-4 md:px-6">
                ...
                >
                    Additionally, I have expertise in performance optimization, scalability, and mentoring junior developers.
                </motion.p>
            </div>
        </section>
    );
